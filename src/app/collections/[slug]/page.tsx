...
export async function generateMetadata({
  ...
  const collection = await getCollectionBySlug(getWixServerClient(), slug); // multyple call in a single page so use cash funcation
  ...
  return (
    <div className="space-y-5">
      ...
      <Suspense
        ...
        key={page} // evaer the page change than trigar this
      >
