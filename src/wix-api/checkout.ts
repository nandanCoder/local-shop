...
export interface getCheckoutUrlForProductCartValues {
  product: products.Product;
  quantity: number;
  selectedOptions: Record<string, string>;
}
export async function getCheckoutUrlForProductCart(
  wixClient: WixClient,
  { product, quantity, selectedOptions }: getCheckoutUrlForProductCartValues,
) {
